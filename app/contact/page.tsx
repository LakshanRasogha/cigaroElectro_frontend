            ...
            <form className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none opacity-30 text-slate-900">▼</div>
                </div>
              </div>
...
const ContactMethod = ({ icon, title, detail, isExternal, link }: { icon: React.ReactNode, title: string, detail: string, isExternal?: boolean, link?: string }) => {
  const Component = isExternal ? 'a' : 'div';
  return (
    <motion.div whileHover={{ x: 10 }} className="inline-block w-full">
      <Component 
        href={link} 
