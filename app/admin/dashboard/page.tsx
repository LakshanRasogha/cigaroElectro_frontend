...
const mockCustomers: Customer[] = [
  ...
  },
  {
    ...
    email: "elena.r@lux.co",
    status: "Active",
    totalOrders: 8,
    totalSpent: "$1,150",
    joinedDate: "Dec 2023",
    address: {
      street: "42 Plaza Mayor",
      city: "Madrid",
      state: "MD",
      zip: "28012",
      country: "Spain",
    ...
    <div className='fixed inset-0 z-[60] flex items-center justify-center p-4'>
      ...
      <div className='bg-white w-full max-w-2xl rounded-3xl shadow-2xl relative z-10 overflow-hidden animate-in fade-in zoom-in duration-200'>
        ...
        <div className='p-8 bg-slate-50 flex gap-3'>
          ...
          <button className='flex-1 py-4 bg-rose-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-rose-700 transition-all shadow-lg shadow-rose-600/10'>
            Restrict Access
          </button>
        </div>
      </div>
