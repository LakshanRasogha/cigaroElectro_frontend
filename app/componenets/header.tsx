      ...
      */}
        ...
        <div className='max-w-4xl'>
          ...
          >
            <div className='flex items-center gap-4'>
              ...
              <div>
                <p className='text-white text-xs font-bold tracking-tighter uppercase'>
                  Authentic Gold Tier
                </p>
                <p className='text-zinc-500 text-[10px]'>
                  Verified luxury hardware
                </p>
              </div>
            </div>
            <div className='flex items-center gap-4'>
      ...
      <div className='absolute right-12 bottom-12 hidden xl:block'>
        <div className='flex items-center gap-6 rotate-90 origin-right'>
          <span className='text-[#D4AF37]/30 text-[10px] uppercase tracking-[1em] font-black'>
            Luxury Est. 2024
          </span>
